$(function () {
    ...
    // End tutorial modal Page slider
    ...
    $(".next").click(function () {
        ...
        if (current_position < slide_amount - 1) {
            ...
            setTimeout(function () {
                $(".active_slide")
                    .find(".popone")
                    .removeClass("popone"); // Reset animations
                $(".active_slide")
                    .find(".poptwo")
                    .removeClass("poptwo"); // Reset animations
                $(".active_slide")
                    .find(".popthree")
                    .removeClass("popthree"); // Reset animations
                $(".active_slide")
                    .find(".popfour")
                    .removeClass("popfour"); // Reset animations
            }, 10);
            setTimeout(function () {
    ...
    $("input").mousedown(function () {
        var active_smile = $(this)
            .attr("class")
            .split(" ")
            .pop(); // Get active smile
